      ...
      <div className="flex gap-10 items-center font-space-grotesk text-black text-xl">
        {menu.map((item) => {
          return (
            ...
            >
              <p className="hover-underline-animation cursor-pointer">
                {item.name}
              </p>
            </div>
          );
        })}
        <div className="w-fit overflow-hidden hover-button-animation-header active:scale-[0.96] duration-300 px-[50px] max-lg:py-2 max-lg:px-6 text-xl  py-5 font-space-grotesk border border-secondary rounded-[14px] cursor-pointer relative text-secondary group">
