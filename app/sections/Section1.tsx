    ...
    <div id="about" className="w-full max-w-desktop px-2 mx-auto">
      <div className="flex in-view justify-between mt-10">
        <div className="max-w-[531px] w-full flex flex-col gap-[35px]">
          ...
          <div className="bg-secondary w-fit overflow-hidden  px-[50px] max-lg:py-2 max-lg:px-6 text-xl active:scale-[0.96] duration-300 py-5 font-space-grotesk rounded-[14px] cursor-pointer relative text-white group">
            <p className="z-[1] relative duration-500 select-none group-hover:text-secondary">
              Explore
            </p>
            <div className="absolute top-0 left-0 w-0 duration-500 bg-white border-[2px] rounded-[14px] border-secondary group-hover:w-full h-full transition-all"></div>
          </div>
        </div>
