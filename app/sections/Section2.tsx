...
const Section2 = () => {
  return (
    <div
      id="mechanism"
      className="flex max-w-desktop in-view w-full mx-auto px-2 flex-col gap-[87px] max-md:gap-10"
    >
      <h3 className="font-semibold font-archivo in-view text-white rounded-[7px] bg-primary text-[40px] leading-[44px] w-fit px-2">
        Operational Mechanism
      </h3>
      <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-10 max-md:gap-5">
        {/* box1 */}
        <div className="p-[50px] hover:scale-[1.01]  in-view duration-300 max-md:p-5 h-[307px] max-sm:h-[200px] rounded-[45px] items-center border border-secondary hover:shadow-box transition-all gap-10 flex">
        ...
        {/* box2 */}
        <div className="p-[50px] hover:scale-[1.01]  in-view duration-300 max-md:p-5 h-[307px] max-sm:h-[200px] rounded-[45px] items-center border border-secondary hover:shadow-box transition-all gap-10 flex bg-primary">
          <div className="flex flex-col justify-between h-full">
            <div className="z-[1]">
        ...
        {/* box3 */}
        <div className="p-[50px] hover:scale-[1.01]  in-view duration-300 max-md:p-5 h-[307px] max-sm:h-[200px] rounded-[45px] items-center border border-secondary bg-secondary hover:shadow-box transition-all gap-10 flex">
          <div className="flex flex-col justify-between h-full">
            <div className="z-[1]">
              <p className="bg-white w-fit rounded-[7px] px-2 font-semibold text-[30px] leading-[32px]">
                Draw &
